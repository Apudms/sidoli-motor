        ...
        <div class="topbar-menu-area">
          <div class="container">
            <div class="topbar-menu left-menu">
              <ul>
                <li class="menu-item">
                  <a title="Hotline: (+62) 123 456 789" href="#"><span class="icon label-before fa fa-mobile"></span>WhatsApp: (+62) 123 456 789</a>
                </li>
              </ul>
            </div>
        ...
        <div class="container">
          <div class="mid-section main-info-area">
            ...
            <div class="wrap-logo-top left-section">
              <a href="/" class="link-to-home"><img src="{{ asset('/assets') }}/images/Sidoli Motor.png" alt="SIDOLI MOTOR"></a>
            </div>
