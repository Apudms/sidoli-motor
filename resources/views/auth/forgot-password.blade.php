                    ...
                    <div class=" main-content-area">
                        <div class="wrap-login-item ">
                            <div class="login-form form-item form-stl">
                                <div class="mb-4 text-sm text-gray-600">
                                    Lupa Kata Sandi Anda? Tidak ada masalah. Beri tahu kami alamat email Anda dan kami
                                    akan mengirimi Anda email tautan pengaturan ulang kata sandi yang memungkinkan Anda
                                    memilih yang baru.
                                ...
                                <form name="frm-login" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <input type="submit" class="btn btn-submit" value="Reset Password" name="reset">
                                </form>
                            </div>
                        </div>
                    </div>
